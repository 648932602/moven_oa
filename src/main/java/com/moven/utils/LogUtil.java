...
public class LogUtil {
	 ...
	 *            内容
	 */
	public static void error(@SuppressWarnings("rawtypes") Class clazz, Throwable t) {
	 ...
	 *            内容
	 */
	public static void error(@SuppressWarnings("rawtypes") Class clazz, String message) {
		Logger log = Logger.getLogger(clazz);
		log.error(message);
	}

	public static void error(@SuppressWarnings("rawtypes") Class clazz, Throwable t, String message) {
		Logger log = Logger.getLogger(clazz);
		log.error(message, t);
	}
